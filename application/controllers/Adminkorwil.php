...
class Adminkorwil extends CI_Controller
{
    ...
    function tambahkegiatankorwil()
    {
      ...
      //Tampilan tabel Tambah cabang korwil
      public function Kas()
      {
          $data = array(
          ...
          $data['kegiatan_baru'] = $this->M_keuangan->datakeuangan( "baru" );
          $data['kegiatan_belum_verifikasi'] = $this->M_keuangan->datakeuangan( "belum verifikasi" );
          $data['kegiatan'] = $this->M_keuangan->getalldatakeuangan();
