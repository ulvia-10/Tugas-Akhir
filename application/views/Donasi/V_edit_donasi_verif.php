...
<div class="col-xl-8 box-col-9" style="margin-left: 150px;">
	<div class="card">
		<div class="card-header">
			<h5 style="margin-left:150px;">Verifikasi Bukti Donasi <i class="fa fa-check-circle" aria-hidden="true"></i> </h5>
		</div>
		<form class="form theme-form" action="<?php echo base_url('donasi/proseseditdonasiverif/'. $donasi['Id_donasi']) ?>" method="POST"	enctype="multipart/form-data">
			...
			<div class="row">
				...
				<div class="col" id="element">
					<div class="mb-3 row">
						...
						<div class="col-sm-5">
							<input class="form-control" type="number" maxlength="6" name="jml_donasi" min="0" placeholder="Masukkan nominal">
						</div>
					</div>
				</div>
			</div> 
