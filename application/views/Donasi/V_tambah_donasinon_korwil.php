...
<div class="col-xl-7 box-col-9" style="margin-left: 150px;">
	<div class="card">
		<div class="card-header">
			<h5 style="text-align:center; margin-left:20px;"> Tambah Bukti Donasi <i class="fa fa-id-card"
					aria-hidden="true"></i> </h5>
		</div>

		<form class="form theme-form" action="<?php echo base_url('donasi_non/tambahdonasinonanggotakorwil') ?>"
				...
				<div class="row">
					<div class="col">
						<div class="mb-3 row">
							...
							<div class="col-sm-9">
								<input class="form-control" type="number" maxlength="12" name="telp_donatur"
									placeholder="Masukkan No Telp Donatur">
							</div>
						</div>
					</div>
					<div class="row">
