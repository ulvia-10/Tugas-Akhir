<br><br>
<div class="col-sm-9 col-xl-10" style="margin-left:50px;">
	<div class="card card-absolute">
		<div class="card-header bg-primary">
			<h5 class="text-white"> <i class="fa fa-download" aria-hidden="true"></i> Filter Cetak Laporan</h5>
		</div>
		<div class="card-body">
			<h5 class="text-primary" style="text-align:center;">Cetak Laporan <br> Data Donasi Non Anggota  <i class="fa fa-search" aria-hidden="true"></i>  </h5>
			<br><br>
			<?php echo $this->session->flashdata('flash-data') ?>
			<form action="<?php echo base_url('laporan/exportdonasinon/') ?>" method="POST">
			<div class="row" style="margin-left:50px;">
				...
				<div class="col-md-2">
				<button type="submit" style="margin-top: 35px; margin-left: 400px;"class="btn btn-primary">Cetak</button>
