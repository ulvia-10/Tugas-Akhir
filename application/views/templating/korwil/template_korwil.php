							...
							<ul class="sidebar-links" id="simple-bar">
								...
								<li class="sidebar-list">
									...
									<ul class="sidebar-submenu">
										<li><a href="<?= base_url('profile/profilkorwil'); ?>">My Profile</a>
										</li>
								...
								<li class="sidebar-list">
									<a class="sidebar-link sidebar-title" href="#"><i
											data-feather="folder-plus"></i><span>Kas</span></a>
									<ul class="sidebar-submenu">
										<li><a href="<?= base_url('adminkorwil/kas'); ?>">List Kas Masuk</a>
										</li>
										<li><a href="<?= base_url('Adminkorwil/tabeltotalKeuangan'); ?>">Data Kas</a>
										</li>
										<li><a href="<?= base_url('laporan/index/'); ?>"> Laporan Kas</a></li>
										<li><a href="<?= base_url('laporan/indexneraca'); ?>"> Laporan Neraca</a></li>
										<li><a href="<?= base_url('laporan/indexlabarugi'); ?>">Laporan Laba Rugi</a>
										</li>
									</ul>
								</li>
								...
								<li class="sidebar-list"
									...
									<a class="sidebar-link sidebar-title link-nav"
										href="<?= base_url('adminkorwil/kegiatan'); ?>"><i data-feather="users">
								...
								<li class="sidebar-list">
									<a class="sidebar-link sidebar-title" href="#"><i
											data-feather="loader"></i><span>Donasi</span></a>
									<ul class="sidebar-submenu">
								...
								<li class="sidebar-list"
									<?= $this->uri->segment(2) == 'cabangkegiatan' ? 'class="sidebar-submenu"' : '' ?>>
									<a class="sidebar-link sidebar-title link-nav"
										href="<?= base_url('login/logout'); ?>"><i data-feather="log-out">
