...
<div class="col-sm-5" >
 	<div class="card">
		...
		<div class="card-body">
       <img src="<?= base_url('./assets/images/' . $kas['bukti_bayar']); ?>" alt="Maaf bukti pembayaran tidak tersedia" style="width:50%; height:45%; margin-left:90px;">
       <!-- <?php
                        ...
                        if ($kas['bukti_bayar']) {
                            ...
                            if (count($checkDataPhoto) > 1) {
                                ...
                                echo '<img src="' . base_url('./assets/images/' . $kas['bukti_bayar']) . '" style="width: 100px"; height:100px;>';
                            }
                        }
