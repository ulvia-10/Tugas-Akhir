 ...
 <div class="col-sm-12 col-xl-10" style="margin-left:50px;">
                <div class="card card-absolute">
                  <div class="card-header bg-secondary">
                    <h5 class="text-white"> <i class="fa fa-download" aria-hidden="true"></i>  Filter Cetak Data</h5>
                  </div>
                  <div class="card-body">
                	<?php echo $this->session->flashdata('flash-data') ?>
						<form action="<?php echo base_url('C_data/exportLaporanPDF') ?>" method="GET">
							<div class="row">
				  <h5 style="text-align:center;">Laporan Neraca <i class="fa fa-spin fa-spinner"></i></h5>      
				  <br><br>
                  <?php echo $this->session->flashdata('flash-data') ?>
						<form action="<?php echo base_url('laporan/exportlaporanneraca') ?>" method="GET">
							<div class="row" style="margin-left:50px;">
								...
								<div class="col-md-2"><a href="<?php echo base_url('C_data') ?>"
										class="btn btn-secondary">Cetak</button></div>
								<div class="col-md-2"><a href="<?php echo base_url('laporan/laporanneraca') ?>"
