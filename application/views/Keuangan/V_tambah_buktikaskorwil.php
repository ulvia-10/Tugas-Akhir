...
<div class="col-xl-8 box-col-9" style="margin-left: 150px;">
	<div class="card">
		...
		<form class="form theme-form" action="<?php echo base_url('keuangan/uploadbuktikaskorwil') ?>" method="POST"
				...
				<div class="row">
					<div class="col">
						<div class="mb-3 row">
							...
							<div class="col-sm-5">
								<input class="form-control" type="number" maxlength="6" name="nominal" min="0"
